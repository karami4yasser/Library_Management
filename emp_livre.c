...
void emp_livre_function(int argc, char *argv[] )
{
    ...
    ////////////////////////////////////////////
        gtk_window_set_title(GTK_WINDOW(window),"YAYALIB|EMP_BOOK");
    ...
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(emp_this_book),box_adh);
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(emp_this_book),box_livre);
