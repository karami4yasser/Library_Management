...
void user_function(int argc, char *argv[] )
{
    ...
    ////////////////////////////////////////////
        gtk_window_set_title(GTK_WINDOW(window),"YAYALIB|ADD_USER");
    ...
    image = gtk_image_new_from_file("user_add.png");
...
//g_signal_connect (G_OBJECT (buttonsave), "clicked", G_CALLBACK (user_add_secces), (gpointer) window);
   ...
   all_widgets[5]=textspace;
    ...
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),(*all_widgets));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+1));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+2));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+3));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+4));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+5));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+6));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+7));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+8));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+9));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+10));
    g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),*(all_widgets+10));
        g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(back), window);

    //g_signal_connect (G_OBJECT(buttonsave), "clicked", G_CALLBACK(add_this),NULL);

    //g_signal_connect (G_OBJECT(buttonsave), "button-released-event", G_CALLBACK(gtk_main_quit),NULL);
